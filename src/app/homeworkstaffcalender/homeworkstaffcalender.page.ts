...
@Component({
  selector: 'app-homeworkstaffcalender',
  templateUrl: './homeworkstaffcalender.page.html',
  styleUrls: ['./homeworkstaffcalender.page.scss'],
})
export class HomeworkstaffcalenderPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  constructor(public formBuilder: FormBuilder, private assignhomeworkservice: AssignhomeworkService, private feeservice: FeesService, public menuCtrl: MenuController, private storage: StorageService, private route: ActivatedRoute, private router: Router, private ionLoaderService: IonLoaderService,
...
console.log("this.tid--",this.tid);
  ...
  genreport() {
   ...
   //this.ionLoaderService.autoLoader();
      ...
      this.assignhomeworkservice.StaffHomeworkAssignedList(this.dateParts_to,this.tid).subscribe((res) => {
