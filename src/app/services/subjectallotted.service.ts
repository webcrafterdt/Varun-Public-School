...
export class SubjectallottedService {

  constructor(private http: HttpClient) {
  }
    POSTDATA:any=[];
  
    subject_allotted(): Observable<any>
    {
  ...
  console.log('post_circular ==>',this.POSTDATA);
      ...
      return this.http.post(`${environment.baseUrl}api_assignedsubject`,this.POSTDATA,httpOptions)
