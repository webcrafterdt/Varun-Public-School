...
@Component({
  selector: 'app-stugroupdetail',
  templateUrl: './stugroupdetail.page.html',
  styleUrls: ['./stugroupdetail.page.scss'],
})
export class StugroupdetailPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  chatbox(id,id2)
  {
    //this.router.navigate(["/teachchatbox",id]);
    this.router.navigate(["/stuchatbox",id,'',id2]);
  }
