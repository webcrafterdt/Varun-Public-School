...
@Component({
  ...
  templateUrl: './teachcircular.page.html',
  styleUrls: ['./teachcircular.page.scss'],
})
  export class TeachcircularPage implements OnInit {
  circulars:any=[];
  status:any;
  message:any;
  ...
  // this.ionLoaderService.simpleLoader();
    this.homeworkservice.teachercircular().subscribe((res) =>{
