...
@Component({
  selector: 'app-teachclassfees',
  templateUrl: './teachclassfees.page.html',
  styleUrls: ['./teachclassfees.page.scss'],
})
export class TeachclassfeesPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  genreport() {
    ...
    this.feeservice.fees_detail(this.fromdate_post, this.ToDate, '').subscribe((res) => {
      console.log('this.fromdate_post 2==>', this.fromdate_post);
  ...
  // {
  //   console.log("id====>",id);
  //   this.router.navigate(["/teachsecfees",id]);
  // }
