...
@Component({
  selector: 'app-teachclassfeesrecon',
  templateUrl: './teachclassfeesrecon.page.html',
  styleUrls: ['./teachclassfeesrecon.page.scss'],
})
export class TeachclassfeesreconPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  genreport() {
    ...
    this.feeservice.fees_detail_rec_on(this.fromdate_post, this.ToDate,'').subscribe((res) => {
      console.log('this.fromdate_post 1==>', this.fromdate_post);
      console.log('this.this.ToDate 1==>', this.ToDate);
...
console.log("this.Final_Due_Amount_ArrayObject==>",this.Final_Due_Amount_ArrayObject);
  ...
  secwisePaid(id,id1)
  {
    ...
    this.router.navigate(["/teachsecfeesrecon",id,id1]);
