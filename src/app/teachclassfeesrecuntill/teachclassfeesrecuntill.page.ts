...
@Component({
  selector: 'app-teachclassfeesrecuntill',
  templateUrl: './teachclassfeesrecuntill.page.html',
  styleUrls: ['./teachclassfeesrecuntill.page.scss'],
})
export class TeachclassfeesrecuntillPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  genreport() {
    ...
    this.feeservice.fees_detail_rec_untill(this.fromdate_post, this.ToDate,'').subscribe((res) => {
      console.log('this.fromdate_post 1==>', this.fromdate_post);
      console.log('this.ToDate 1==>', this.ToDate);
      console.log('res fees_detail_rec_on fees details==>', res);
      ...
      this.Final_Due_Amount_Array=res['Final_Due_Amount_Array'];
      this.Final_Due_Amount_ArrayObject=Object.keys(res['Final_Due_Amount_Array']);

console.log("this.Final_Due_Amount_Array cls==>",this.Final_Due_Amount_Array);
console.log("this.Final_Due_Amount_ArrayObject==>",this.Final_Due_Amount_ArrayObject);
  ...
  secwisePaid(id)
  {
    ...
    this.router.navigate(["/teachsecfeesrecuntill",id]);
...
//./teachsecfeesrecon-routing.module
