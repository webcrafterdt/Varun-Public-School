...
export class TeacherprofilePage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.address1=localStorage.getItem('add1');
   ...
   this.image=localStorage.getItem('image');
    this.address=localStorage.getItem('add1');
    this.department=localStorage.getItem('DepartmentName');
    this.designation=localStorage.getItem('DesignationName');
