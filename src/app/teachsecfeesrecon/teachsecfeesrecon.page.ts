...
@Component({
  selector: 'app-teachsecfeesrecon',
  templateUrl: './teachsecfeesrecon.page.html',
  styleUrls: ['./teachsecfeesrecon.page.scss'],
})
export class TeachsecfeesreconPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
...
console.log("this.Final_Due_Amount_ArrayObject==>",this.Final_Due_Amount_ArrayObject);
  ...
  stuwiseDue(id,id1)
  {
    console.log("id====>",id);
    console.log("id====>",id1);
    this.router.navigate(["/teachstufeesrecon",id,id1]);
