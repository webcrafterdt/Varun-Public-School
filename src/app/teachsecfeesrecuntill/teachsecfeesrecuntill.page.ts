...
@Component({
  selector: 'app-teachsecfeesrecuntill',
  templateUrl: './teachsecfeesrecuntill.page.html',
  styleUrls: ['./teachsecfeesrecuntill.page.scss'],
})
export class TeachsecfeesrecuntillPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
...
console.log("this.Final_Due_Amount_ArrayObject==>",this.Final_Due_Amount_ArrayObject);
  ...
  stuwiseDue(id,id1)
  {
    console.log("id====>",id);
    console.log("id1====>",id1);
    this.router.navigate(["/teachstufeesrecuntill",id,id1]);
