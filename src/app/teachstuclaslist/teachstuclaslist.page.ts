...
@Component({
  selector: 'app-teachstuclaslist',
  templateUrl: './teachstuclaslist.page.html',
  styleUrls: ['./teachstuclaslist.page.scss'],
})
export class TeachstuclaslistPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  ngOnInit() {
    ...
    this.attendanceservice.StuClassList().subscribe((res) => {
