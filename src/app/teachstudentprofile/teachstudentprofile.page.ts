...
@Component({
  selector: 'app-teachstudentprofile',
  templateUrl: './teachstudentprofile.page.html',
  styleUrls: ['./teachstudentprofile.page.scss'],
})
export class TeachstudentprofilePage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  classwiseDue()
  {
    this.router.navigate(["/teachclassfees"]);
  }

  classwiseReceived()
  {
    this.router.navigate(["/teachclassfeesrecon"]);
  }

  classwiseReceivedUntill()
  {
    this.router.navigate(["/teachclassfeesrecuntill"]);
  }
  ...
  genreport() {
    ...
    this.feeservice.studetail(this.stuid).subscribe((res) => {

      console.log('res student details==>', res);
