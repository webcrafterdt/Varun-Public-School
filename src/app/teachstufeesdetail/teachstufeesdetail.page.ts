...
@Component({
  selector: 'app-teachstufeesdetail',
  templateUrl: './teachstufeesdetail.page.html',
  styleUrls: ['./teachstufeesdetail.page.scss'],
})
export class TeachstufeesdetailPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  constructor(public formBuilder: FormBuilder, private feeservice: FeesService, public menuCtrl: MenuController, private storage: StorageService, private route: ActivatedRoute, private router: Router, private ionLoaderService: IonLoaderService,
    ...
    console.log('this.stuid--xxx>', this.stuid);
  ...
  genreport() {
    ...
    this.feeservice.fees_bill_detail(this.stuid).subscribe((res) => {
      console.log("FeesDetails ====>",res);
      this.billgroupdetail=res;
