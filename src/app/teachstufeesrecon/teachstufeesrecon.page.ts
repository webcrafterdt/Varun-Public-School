...
@Component({
  selector: 'app-teachstufeesrecon',
  templateUrl: './teachstufeesrecon.page.html',
  styleUrls: ['./teachstufeesrecon.page.scss'],
})
export class TeachstufeesreconPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  genreport() {
    ...
    this.feeservice.fees_detail_rec_on(this.fromdate_post, this.ToDate,this.classname).subscribe((res) => {
