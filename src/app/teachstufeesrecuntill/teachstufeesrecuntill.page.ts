...
@Component({
  selector: 'app-teachstufeesrecuntill',
  templateUrl: './teachstufeesrecuntill.page.html',
  styleUrls: ['./teachstufeesrecuntill.page.scss'],
})
export class TeachstufeesrecuntillPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  genreport() {
    ...
    this.feeservice.fees_detail_rec_untill(this.fromdate_post, this.todate_post,this.classname).subscribe((res) => {

      console.log('res fees details Stu==>', res);
      ...
      this.Final_Due_Amount_Array=res['ST_Final_Due_Amount_Array'];
      this.Final_Due_Amount_ArrayObject=Object.keys(res['ST_Final_Due_Amount_Array']);
      //ST_Final_Due_Amount_Array
...
console.log("this.Final_Due_Amount_ArrayObject==>",this.Final_Due_Amount_ArrayObject);
  ...
  stufeedetail(id)
  {
    console.log("Stu id====>",id);
     this.router.navigate(["/teachstufeesdetail",id]);
