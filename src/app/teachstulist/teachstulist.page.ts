...
@Component({
  selector: 'app-teachstulist',
  templateUrl: './teachstulist.page.html',
  styleUrls: ['./teachstulist.page.scss'],
})
export class TeachstulistPage implements OnInit {
  session: any;
  f_id: any;
  college: any;
  ionicForm: FormGroup;
  ...
  chatbox(id1,id2)
  {
    ...
    this.router.navigate(["/teachchatbox",'',id1,id2]);
  }
